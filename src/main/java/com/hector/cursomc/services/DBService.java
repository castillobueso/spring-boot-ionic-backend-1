...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat3 = new Categoria(null, "Camas mesa e banho");
		...
		Estado est2 = new Estado(null, "São Pablo");
		
		Cidade c1 = new Cidade(null, "Uberlandia", est1);
		Cidade c2 = new Cidade(null, "São Pablo", est2);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENDE, ped2, sdf.parse("20/10/2017 00:00"), null);
